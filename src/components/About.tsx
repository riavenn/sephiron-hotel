    ...
    <section
      ...
      className="bg-white py-20">
        ...
        <div className="relative h-[300px] md:h-[500px]">
          ...
          <div className="absolute bottom-0 right-0 w-3/5 h-3/5 rounded-lg overflow-hidden border-8 border-white shadow-2xl hidden md:block">
            <Image
        ...
        <div className="text-center md:text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
            <div className="relative p-6 border-2 rounded-lg group hover:bg-stone-700 transition-all duration-300">
              <h4 className="text-xl font-bold text-gray-800 group-hover:text-white">Luxury Rooms</h4>
              <p className="text-gray-600 mt-2 group-hover:text-gray-200">Elegantly designed rooms with breathtaking views.</p>
            </div>
            <div className="relative p-6 border-2 rounded-lg group hover:bg-stone-700 transition-all duration-300">
              <h4 className="text-xl font-bold text-gray-800 group-hover:text-white">Exceptional Service</h4>
              <p className="text-gray-600 mt-2 group-hover:text-gray-200">Our dedicated staff is here to cater to your every need.</p>
            </div>
          </div>
        </div>
      </div>
