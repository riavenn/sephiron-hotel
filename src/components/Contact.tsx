        ...
        <div className="bg-white p-8 rounded-lg shadow-2xl">
          ...
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="adults" className="block text-sm font-medium text-stone-700">Adults</label>
                <input type="number" id="adults" name="adults" min="1" defaultValue="2" className="mt-1 block w-full p-3 border border-stone-300 rounded-md shadow-sm focus:ring-stone-500 focus:border-stone-500 text-stone-900" />
              </div>
              <div>
                <label htmlFor="children" className="block text-sm font-medium text-stone-700">Children</label>
                <input type="number" id="children" name="children" min="0" defaultValue="0" className="mt-1 block w-full p-3 border border-stone-300 rounded-md shadow-sm focus:ring-stone-500 focus:border-stone-500 text-stone-900" />
              </div>
            </div>
            <button type="submit" className="w-full bg-stone-700 text-white py-3 px-6 rounded-lg hover:bg-stone-800 transition duration-300 mt-4 cursor-pointer">
              Check Availability
            </button>
          </form>
        </div>
